...
public class Round
{
    ...
    private final Stack<Action> finalActions;  //merged list of playerActions and computerActions
    private final ArrayList<Character> playerCharacters;  //list of player character
    private final ArrayList<Character> aiCharacters;      //List of ai character
    ...
    /**
     * Method to play a round (execute the actions and reinitialize for next
     * round)
     */
    public void play()
    {
     ...
     * @throws rpgException.CharatcerExistsException Exception if exception is
     * not found in list
     */
